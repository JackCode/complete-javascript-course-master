...
// // Parsing - must start with a number
...
// // Check if is literally the value NaN
...
// console.log(Math.max(5, -48, 100, 36));
// console.log(Math.max('5', 23, '100'));
...
// console.log(new Date('Dec 04 2022 22:38:37'));
